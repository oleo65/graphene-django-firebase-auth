...
class FirebaseAuthSettings:
    """
    Settings supplied via dictionary named `FIREBASE_AUTH` in Django settings file.
    """
    ...
    def user_settings(self):
        if not hasattr(self, '_user_settings'):
            self._user_settings = getattr(settings, 'FIREBASE_AUTH', {})
